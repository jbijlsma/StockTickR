...
{
    private readonly SemaphoreSlim _marketStateLock = new(1, 1);
    private readonly SemaphoreSlim _updateStockPricesLock = new(1, 1);

    private readonly ConcurrentDictionary<string, Stock> _stocks = new();

    private readonly Subject<Stock> _subject = new();
